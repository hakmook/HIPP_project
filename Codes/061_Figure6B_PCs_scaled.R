...
independent_vars_full <- "Gender + PC1 + PC2 + PC3 + PC4 + PC5 + Donor_HbA1c_s + Age_years_s + center + BMI_s + PreShipmentCultureTime + IsletTransitTime"
independent_vars_reduced <- "PC1 + PC2 + PC3 + PC4 + PC5 + Donor_HbA1c_s + Age_years_s + center + BMI_s + PreShipmentCultureTime + IsletTransitTime"
