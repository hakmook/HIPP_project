...
vars_int <- c("Islet_diameter_preperi", "Islet_area_preperi", "Islet_perimeter_preperi",
...
############################################
### Glucagon secretion and Islet_diameter_preperi
########################################
Summary_Table = vector(mode='list', length=2)
...
############################################
### Insulin secretion and Islet_area_preperi
########################################
Summary_Table = vector(mode='list', length=2)
...
############################################
### Glucagon secretion and Islet_area_preperi
########################################
Summary_Table = vector(mode='list', length=2)
...
############################################
### Insulin secretion and Islet_perimeter_preperi
########################################
Summary_Table = vector(mode='list', length=2)
...
############################################
### Glucagon secretion and Islet_perimeter_preperi
########################################
Summary_Table = vector(mode='list', length=2)
...
Summary_Table
############################################
### Insulin secretion and Islet_diameter_postperi
########################################
Summary_Table = vector(mode='list', length=2)
...
############################################
### Glucagon secretion and Islet_diameter_postperi
########################################
Summary_Table = vector(mode='list', length=2)
...
Summary_Table
############################################
### Insulin secretion and Islet_area_postperi
########################################
Summary_Table = vector(mode='list', length=2)
...
############################################
### Glucagon secretion and Islet_area_postperi
########################################
Summary_Table = vector(mode='list', length=2)
...
Summary_Table
############################################
### Insulin secretion and Islet_perimeter_postperi
########################################
Summary_Table = vector(mode='list', length=2)
...
############################################
### Glucagon secretion and Islet_perimeter_postperi
########################################
Summary_Table = vector(mode='list', length=2)
...
Summary_Table
############################################
### Insulin secretion and Islet_diameter
########################################
Summary_Table = vector(mode='list', length=2)
...
############################################
### Glucagon secretion and Islet_diameter
########################################
Summary_Table = vector(mode='list', length=2)
...
Summary_Table
############################################
### Insulin secretion and Islet_area
########################################
Summary_Table = vector(mode='list', length=2)
...
############################################
### Glucagon secretion and Islet_area
########################################
Summary_Table = vector(mode='list', length=2)
...
Summary_Table
############################################
### Insulin secretion and Islet_perimeter
########################################
Summary_Table = vector(mode='list', length=2)
...
############################################
### Glucagon secretion and Islet_perimeter
########################################
Summary_Table = vector(mode='list', length=2)
